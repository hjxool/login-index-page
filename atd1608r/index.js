...
let channelDetail = `${url}api/atd/channelDetail`;
let channelControl = `${url}api/atd/channelControl`;
...
new Vue({
	...
	data() {
		return {
			loginToken: '',
			userName: '',
			device_id: '20220422_101019_4280832141141228',
			static_param: {
				options: [''], //导航栏
